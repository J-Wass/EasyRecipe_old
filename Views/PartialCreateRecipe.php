    ...
    <script>
        ...
        $("#bAddDirection").click(function () {
            $("#Direction" + DirectionCount++).parent("div").parent("li").after(
                '<li style="list-style: none;"><div class="input-group"><div class="input-group-addon">Step ' +
                DirectionCount +
                '</div><textarea class="form-control" placeholder="Steps..." id = "Direction' +
                DirectionCount + '"></textarea><br /></div></li>'
            )
        });
        ...
        $("#bAddIngredient").click(function () {
            $("#Amt" + IngredientCount++).parent("div").after(
                '<br /><div class="col-sm-8"><input class="form-control" placeholder="ex) Water, Tuna, Tomatoes, etc..." id = "Ingredient' +
                IngredientCount +
                '"/></div><div class="col-sm-4"><input class="form-control" placeholder="ex) 2 cups, 12 oz, etc..." id = "Amt' +
                IngredientCount + '"/></div>');
        });
        ...
        $("#bSubmit").click(function () {
            ...
            $("input, textarea").each(function () {
                if ($(this).val().length == 0) {
                    alert(
                        "Please fill out all fields. You can remove unwanted steps and ingredients using the delete buttons."
                    );
                    kill = true;
                    return false;
                }
